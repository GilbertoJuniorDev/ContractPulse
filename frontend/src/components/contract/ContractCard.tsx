...
const TYPE_COLORS: Record<ContractType, string> = {
  ...
  FIXED_OVERAGE: 'bg-indigo-100 text-indigo-700',
  PROFIT_SHARING: 'bg-purple-100 text-purple-700',
}
...
export default function ContractCard({ contract, onClick }: ContractCardProps) {
  ...
  return (
    <button
      ...
      className="w-full rounded-lg border border-gray-200 bg-white p-5 text-left shadow-sm transition-shadow hover:shadow-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
    >
