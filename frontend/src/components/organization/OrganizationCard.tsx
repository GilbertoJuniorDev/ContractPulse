...
export default function OrganizationCard({
  ...
  return (
    <div className="rounded-xl border border-gray-200 bg-white p-5 shadow-sm transition-all hover:shadow-md dark:border-dark-border dark:bg-dark-card dark:shadow-none dark:hover:shadow-glow">
